  ...
  <div class="footer-main">
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="footer-links">
            <h3 class="footer-brand mb-2">First Light</h3>
            <div class="footer-link-list">
             <a href="#" class="footer-links"><i class="fas fa-compass"></i> Khartoum, Bahri, Kafouri</a>
             <a href="tel:990063151" class="footer-links"><i class="fas fa-phone"></i> +249-9900-63151</a>
             {{-- <a href="tel:98400001511" class="footer-links"><i class="fas fa-mobile"></i> +977-9840003200</a> --}}
             <a href="mailto:info@First Light.com" class="footer-links"><i class="fas fa-envelope"></i> First Light@gmail.com</a>
